...
# FILE: utils/dgpo_expert.py
# DGPO-Foundation Expert: Modified ScriptedExpert for RL training.
# Key changes: All timeouts and failure handling REMOVED.
# The FSM will wait indefinitely for transitions - this is intentional
# because in DGPO training, the robot follows expert actions and will reach targets.
...
class DGPOExpert:
    ...
    """
    def __init__(self, object_profile: ObjectProfile, cfg: DGPOExpertConfig = None):
        self.cfg = cfg if cfg is not None else DGPOExpertConfig()
    ...
    def get_target_pose(
        ...
        # NOTE: Global timeout REMOVED for DGPO training.
        # The expert will wait as long as needed for each state transition.
        ...
        if self._state == "MOVE_TO_PRE_GRASP":
            ...
            # NOTE: Timeout check REMOVED for DGPO training.
