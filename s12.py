...
# (Universal Strategist v9.4 - Production Grade)
...
# ==============================================================================
# 2. STATE ESTIMATOR (Oracle Phase Detection)
# ==============================================================================
...
class AWSPEvaluator:
    def __init__(self, cfg: DictConfig):
        ...
        # 2. Detect Architecture (Auto-Switch)
        ...
        try:
            for ep_idx in tqdm(range(self.cfg.num_episodes), desc="Evaluating"):
                ...
                for step in range(self.cfg.max_steps):
                    ...
                    # --- A. DYNAMIC INPUT CONSTRUCTION ---
                    batch = {}
                    if self.arch_type == "v8.0":
                        # v8.0 needs Phase, does NOT need prev_image
                        batch = {
                        ...
                        # v9.0 needs History, does NOT need Phase input
                        batch = {
                    ...
                    phase_names = ["REACH", "GRASP", "MOVE", "PLACE"]
                    phase_txt = phase_names[min(phase, 3)]
